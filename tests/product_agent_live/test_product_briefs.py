...
def test_material_revision_increments_version_and_supersedes_prior_unapproved_version() -> None:
    ...
    first = service.create_or_reuse(_context(), "synthetic context")
    second = service.create_or_reuse(_context(created_at_ms=1_700_000_010_000), "synthetic context")
...
def test_approved_version_is_preserved_when_new_version_is_created() -> None:
    ...
    second = service.create_or_reuse(_context(created_at_ms=1_700_000_200_000), "synthetic context")
...
def test_superseded_version_rejection() -> None:
    ...
    first = service.create_or_reuse(_context(), "synthetic context")
    service.create_or_reuse(_context(created_at_ms=1_700_000_020_000), "synthetic context")
